...
create table t_commodity(
	...
	cpic varchar2(100) not null,						--商品图片信息(  可多张, 以 ; 分隔  )
	...
	cstate_dingdan	Integer delfault 2,							--订单审核状态(1.待审核 2.通过 3.未通过)
...
create table t_needcom(
	...
	ndate date ,										--发布求购信息时间
	norder	Integer delfault 2,							--订单审核状态(1.待审核 2.通过 3.未通过)
	nmessage varchar2(100) ,							--审核信息(比如未通过: 理由)
	nadminname varchar2(20)						--订单审核的管理员
);
